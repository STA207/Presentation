...
#jpeg("/Users/rongkui/Desktop/Classes/STA207/Presentation/USmap.jpeg")
plot_usmap(data = data_map, values = "fatal_rate", color = "#0072B2", exclude = c("AK","HI", "DC")) + 
  scale_fill_continuous(name = "Fatality Rate", label = scales::comma) + 
...
#   scale_fill_continuous(name = "Mean Fatality Rate, 1982-1988", label = scales::comma) + 
#   theme(legend.position = "right") 
# dev.off()
```
