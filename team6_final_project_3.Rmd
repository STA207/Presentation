...
```{r, include = FALSE}
fit4 <- lm(log(fatal_rate) ~ region + year + jail, data = dta_m)
```
...
|-----------|-----------|------------|---------|
| Intercept | 1.80953   | 0.12398 | 14.596
| jail    |     0.04793 |   0.07357  | 0.652
...
|jail | 1| 4.904 |4.9042|  1.6355|
|region| 3 | 29.646 | 9.8820 | 
|year|
